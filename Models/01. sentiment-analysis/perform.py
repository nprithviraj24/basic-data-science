...
#     sample1 = lines[2].split()
#     sample2 = lines[3].split()
#     sample3 = lines[4].split()
#     sample4 = lines[5].split()

#     # if()
    
#         # tobesent['negativeRecall'] = float(rownegative[2])
#         # tobesent['negativeSupport'] = float(rownegative[4]) 
#         # tobesent['positiveRecall'] = float(rowpositive[2])
#         # tobesent['positiveSupport'] = float(rowpositive[4])
#     # negativeSupport = rownegative[0].split('\t')
#     # print(tobesent)
#     # print(rownegative)
#     # print(rowpositive)
#     return tobesent
...
# def send_val():
    # if(recall_values['LR']['positiveRecall'] > recall_values['SGD']['positiveRecall'] ):
    #     if(recall_values['LR']['positiveRecall'] > recall_values['SVC']['positiveRecall']):
    #         return recall_values['LR']
    #     else:
    #         return recall_values['SVC']
    # elif(recall_values['LR']['positiveRecall'] < recall_values['SGD']['positiveRecall']):
    #     if(recall_values['SGD']['positiveRecall'] > recall_values['SVC']['positiveRecall']):
    #         return recall_values['SGD']
    #     else:
    #         return recall_values['SVC']
    # else:
    #     return recall_values['SVC']
...
def init():
    prediction = dict()
    test_size = 0.2
    htmlpath = "G:\\py\\data-visualization\\sentiment-analysis\\"
    file_path = "G:\\py\\data-visualization\\sentiment-analysis\\15kTestData.txt"
    ...
    text_clf_SGDClassifier = Pipeline([
                         ('vect', CountVectorizer(analyzer=split_into_lemmas, ngram_range=(2,4), stop_words='english',lowercase=True)),
    ...
    #LogisticRegression
    text_clf_LogisticRegression = Pipeline([('vect', 
                         CountVectorizer(analyzer=split_into_lemmas, ngram_range=(2,4), stop_words='english',lowercase=True)),
                         ('tfidf', TfidfTransformer()),
    ...
    text_clf_MultinomialNB = Pipeline([('vect', 
                         CountVectorizer(analyzer=split_into_lemmas, ngram_range=(2,4), stop_words='english',lowercase=True)),
                         ('tfidf', TfidfTransformer()),
                         ('clf', MultinomialNB()),
    ])
    ...
    with open('Support-Vector-Machine.html', 'w') as myFile:
            ...
            if(array1[1][1]>=array1[0][0]):
                myFile.write('<h5>Since there are more number of POSITIVE Reviews: <strong> %s </strong>, Hence the general sentiment is <strong>Positive!</strong></h5>' % array1[1][1])
            else: 
                myFile.write('<h5>Since there are more number of Negative Reviews: <strong> %s </strong>, Hence the general sentiment is <strong>Negative!</strong></h5>' % array1[0][0])
    ...
    # send_recall(classification_report(y_test, predicted_SGDClassifier))
    # print(recall_values['LR']['positiveRecall'])
    # if(recall_values['LR']['positiveRecall'] > recall_values['SGD']['positiveRecall'] ):
    #     if(recall_values['LR']['positiveRecall'] > recall_values['SVC']['positiveRecall']):
    #         return recall_values['LR']
    #     else:
